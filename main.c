...
float for_loop_testing()
{
    ...
    //this will run the same amount of times as the int specified in loop count
...
string print_ascii_string_value()
{
    // TODO:: Write a while loop that takes a string that you query the user for
    //          then print out each letter with their matching ascii value
    // TODO:: Also print out the characters position in the string
    
    string str =  get_string ("What string/word do you want to know the ASCII values of the letters of? ");
    ...
    while(i < strSize){
        ...
        //printf statment for each letter
        str [0];
        int asciiVal =  str[i];
